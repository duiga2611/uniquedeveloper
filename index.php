					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/duong.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Dinh tung duong</h4>
									<h4 class="team-member-designation">bao cao</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/DuongDinh1703" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="team-member text-center">
								<img src="img/dinh.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Dinh</h4>
									<h4 class="team-member-designation">code </h4>
									<ul class="social-list">
